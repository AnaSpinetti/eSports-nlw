...
app.get('/games/:id/ads', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res.json(ads.map(ad => {
        return Object.assign(Object.assign({}, ad), { weekDays: ad.weekDays.split(','), hourStart: (0, convert_minutes_string_to_hour_1.convertMinutesStringToHours)(ad.hourStart), hourEnd: (0, convert_minutes_string_to_hour_1.convertMinutesStringToHours)(ad.hourEnd) });
    }));
}));
app.get('/ads/:id/discord', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const adId = req.params.id;
    const ad = yield prisma.ads.findUniqueOrThrow({
        select: {
            discord: true,
        },
        where: {
...
app.post('/games/:id/ads', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const gameId = req.params.id;
    const body = req.body;
    const ad = yield prisma.ads.create({
        data: {
            gameId,
            name: body.name,
