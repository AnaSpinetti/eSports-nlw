      ...
      <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg">
        ...
        <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <InputForm name='name' id='name' placeholder='Como te chamar dentro do jogo?' />
          </div>
          ...
          <div className='grid grid-cols-2 gap-6'>
            ...
            <div className='flex flex-col gap-2'>
              ...
              <InputForm name='discord' id='discord' type='text' placeholder='Usuario#0000' />
            </div>
          </div>
          ...
          <div className='flex gap-6'>
            ...
            <div className='flex flex-col gap-2 flex-1'>
              ...
              <div className='grid grid-cols-2 gap-2'>
                <InputForm name='hourStart' id='hourStart' type='time' placeholder="De" />
                <InputForm name='hourEnd' id='hourEnd' type='time' placeholder="Até" />
              </div>
            </div>
          </div>
